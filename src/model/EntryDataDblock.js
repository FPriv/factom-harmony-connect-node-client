...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HarmonyConnectClient.EntryDataDblock = factory(root.HarmonyConnectClient.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>EntryDataDblock</code>.
   ...
   * @alias module:model/EntryDataDblock
   * @class
   */
  ...
  /**
   * Constructs a <code>EntryDataDblock</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EntryDataDblock} obj Optional instance to populate.
   * @return {module:model/EntryDataDblock} The populated <code>EntryDataDblock</code> instance.
   */
